...
import { AGDialogSvc, InputControlService, InputService } from '@shared/services';
import { TxService } from '@ag-app/services';
import { CharMap } from '@ag-app/components';
import { DialogModule } from 'primeng/dialog';
import { DynamicDialogRef } from 'primeng/dynamicdialog';
import { isStrArray, isStrRecord, isWeakObj } from '@shared/typing';
import { AppDataModel } from '@ag-app/core';
import { downloadTextAsFile } from '@shared/core';
import { FormsModule } from '@angular/forms';
import { min } from 'lodash';
import { LogCleanInputSettings } from '@ag-app/models';
import { InputBase } from '@shared/models';
import { MenuItem, MenuItemCommandEvent } from 'primeng/api';
import { Menubar } from 'primeng/menubar';
import { FormDialog } from '@shared/components';
import { MessagingSvc } from '@shared/services';



@Component({
    selector: 'ag-log-cleaner',
    imports: [
        PageLayout,
        TextareaModule,
        CardModule,

...
import { AppDataModel, Endpoints } from '@ag-app/core';
import { toPythonObj } from '@shared/core';
import { environment } from '@ag-env';
import { LogCleanInputSettings, RpLogPayload, RpLogResponse, ServerResponse } from '@ag-app/models';
import { isStrArray, isStrRecord, Predicate, StrRecord, WeakObj } from '@shared/typing';

...
def lc_api_routes(app: Flask | None = None) -> Flask:
    ...
    def set_mapping():
        ...
        return ServerResponse.to_fast(mapping, "mapping successfully set")
    ...
    def change_radio():
        ...
        if playlist:
            ...
            return ServerResponse.to_fast(f"Switching to: {playlist}")

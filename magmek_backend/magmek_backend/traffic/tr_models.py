...
class SimSnapshot(BaseModel):
    ...
    agent_count: int = 0
    agent_limit: int = 110
    agent_limit_max: int = 110
    agent_reserved: int = 10
    agent_unreserved: int = 100
    dynamic_pathfinding: str = "enabled"
    estate_id: int = 0
    estate_name: str = ""
    frame_number: int = 0
    region_cpu_ratio: int = 0
    region_idle: int = 0
    region_product_name: str = "Estate / Full Region 30k"
    region_product_sku: str = "624"
    region_start_time: int = 0
    sim_channel: str = "Second Life Server"
    sim_version: str = ""
    simulator_hostname: str = ""
    region_max_prims: int = 30000
    ...
    health_regen_rate: float = 0.16667
    death_action: int = 0

...
$lang['Your password was successfully set'] = 'Din adgangskode blev gemt';
$lang['must not be empty'] = 'må ikke være tomt';
$lang['you must choose a date'] = 'du skal vælge en dato';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'En fejl er opstået; gå tilbage til <a href="identification.php" title="Log på">Log på</a> eller <a href="register.php">Opret</a>';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Hej <em>%s</em>, skriv din nye adgangskode herunder.';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Tilbage til <a href="identification.php" title="Log på">Log på</a>';
$lang['Set my password'] = 'Opsæt min adgangskode';
$lang['Show expired keys'] = 'Vis udløbne nøgler';
$lang['The api key has been successfully created.'] = 'API-nøglen er oprettet';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Du vil få besked på mailadresse %s, når din API-nøgle er ved at udløbe.';
$lang['The secret key can no longer be displayed.'] = 'Den hemmelige nøgle kan ikke længere vises';
$lang['This API key was manually revoked on %s'] = 'Denne API-nøgle blev manuelt tilbagekaldt den %s';
$lang['To continue using the API, please renew your key before it expires.'] = 'For at fortsætte med at anvende API\'et, skal du forny din nøgle før den udløber.';
$lang['To manage your API keys, please log in with your username/password.'] = 'For at håndtere dine API-nøgler, skal du logge på med dit brugernavn og adgangskode.';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Når aktiveret, vil en fælles skabelon blive anvendt på siderne til login og kontooprettelse, uafhængigt af temaet.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Du man håndtere API-nøgler i dine <a href="%s">kontoindstillinger</a>.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Du har ingen mailadresse, så du vil ikke modtage en besked når din API-nøgle er ved at udløbe.';
$lang['Your API key will expire in %d day.'] = 'Din API-nøgle udløber om %d dag.';
$lang['Your API key will expire in %d days.'] = 'Din API-nøgle udløber om %d dage.';
$lang['Your API key will expire soon'] = 'Din API-nøgæe udløber snart';
$lang['Your changes have been applied.'] = 'Dine ændringer er gemt.';
$lang['Your password was successfully reset'] = 'Din adgangskode blev nulstillet';
$lang['Expires in'] = 'Udløber den';
$lang['Generate API Key'] = 'Generer API-nøgle';
$lang['Generate key'] = 'Generer nøgle';
$lang['Hide expired keys'] = 'Skjul udløbne nøgler';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Ikke muligt at kopiere automatisk. Foretag manuel kopiering.';
$lang['Last use'] = 'Senest anvendt';
$lang['Manage your account'] = 'Håndter din konto';
$lang['Never'] = 'Aldrig';
$lang['New API Key'] = 'Ny API-nøgle';
$lang['No expiration'] = 'Intet udløb';
$lang['Options'] = 'Valgmuligheder';
$lang['Return to the gallery'] = 'Tilbage til galleri';
$lang['Revoke'] = 'Tilbagekald';
$lang['Revoked'] = 'Tilbagekaldt';
$lang['An email has been sent with a link to reset your password'] = 'En e-mail er sendt med et link til nulstilling af din adgangskode';
$lang['Change your password'] = 'Ændr din adgangskode';
$lang['Check your inbox'] = 'Tjek din indbakke';
$lang['Choose how you want to see your gallery'] = 'Vælg hvordan du vil se galleriet';
$lang['Confirm my new password'] = 'Bekræft min nye adgangskode';
$lang['Confirm new password'] = 'Bekræft ny adgangskode';
$lang['Create API Keys to secure your acount'] = 'Opret API-nøgler for at sikre din konto';
$lang['Create a new API key to secure your account.'] = 'Opret en ny API-nøgle for at sikre din konto';
$lang['Create an account'] = 'Opret en konto';
$lang['Created at'] = 'Oprettet den';
$lang['Custom date'] = 'Skræddersyet dato';
$lang['Do you really want to revoke the "%s" API key?'] = 'Vil du virkelig tilbagekalde API-nøglen "%s"?';
$lang['Don\'t have an account yet ?'] = 'Har du ikke allerede en konto?';
$lang['Done'] = 'Udført';
$lang['Duration'] = 'Varighed';
$lang['Edit API Key'] = 'Rediger API-nøgle';
$lang['Expert mode'] = 'Eksperttilstand';
$lang['Expired'] = 'Udløbet';
$lang['Expired on'] = 'Udløb den';
$lang['3xlarge'] = '3XL - ekstremt stort';
$lang['4xlarge'] = '4XK - gigantisk';
$lang['API Key has been successfully edited.'] = 'API-nøglen blev redigeret';
$lang['API Key has been successfully revoked.'] = 'API-nøglen blev tilbagekaldt';
$lang['API Key name'] = 'API-nøgles navn';
$lang['API Key not found'] = 'API-nøgle ikke fundet';
$lang['API Keys'] = 'API-nøgler';
$lang['Account'] = 'Konto';
$lang['Already have an account ?'] = 'Har du allerede en konto?';
$lang['ID copied.'] = 'ID kopieret.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Hvis du ikke modtager en mail, så kontakt din webmaster.';
$lang['Invalid verification code'] = 'Ugyldig verifikationskode';
$lang['Save your ID and secret'] = 'Gem din ID og hemmelighed';
...
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Hvis du ændrede din adgangskode, fordi du tror at den er blevet stjålet, anbefaler vi at trække dine %d API-nøgler tilbage <a href="%s">i din profil</a>.';
...
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Hvis din konto eksisterer, er en verifikationskode blevet sendt til din mailadresse.';
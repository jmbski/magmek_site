...
$lang['Your API key will expire in %d day.'] = 'Το κλειδί σας ΑΡΙ θα λήξει σε %d ημέρα.';
$lang['Your API key will expire in %d days.'] = 'Το κλειδί σας ΑΡΙ θα λήξει σε %d ημέρες.';
$lang['Your API key will expire soon'] = 'Το κλειδί σας ΑΡΙ θα λήξει σύντομα';
$lang['Your changes have been applied.'] = 'Οι αλλαγές σας εφαρμόστηκαν.';
$lang['Your password was successfully reset'] = 'Ο κωδικός σας ανανεώθηκε με επιτυχία';
$lang['Your password was successfully set'] = 'Ο κωδικός σας ορίστηκε με επιτυχία';
$lang['must not be empty'] = 'δεν πρέπει να είναι κενό';
$lang['you must choose a date'] = 'πρέπει να επιλέξετε μια ημερομηνία';
$lang['This API key was manually revoked on %s'] = 'Αυτό το κλειδί ΑΡΙ αποσύρθηκε χειροκίνητα την %s';
$lang['Options'] = 'Επιλογές';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Επέστρεψε στο <a href="identification.php" title="Σύνδεση">Σύνδεση</a>';
$lang['Return to the gallery'] = 'Επέστρεψε στην πινακοθήκη';
$lang['Revoke'] = 'Απέσυρε';
$lang['Revoked'] = 'Αποσύρθηκε';
$lang['Set my password'] = 'Όρισε τον κωδικό μου';
$lang['Show expired keys'] = 'Δείξε τα ληγμένα κλειδιά';
$lang['The api key has been successfully created.'] = 'Το κλειδί ΑΡΙ δημιουργήθηκε με επιτυχία.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Η δ/νση E-Mail %s θα χρησιμοποιηθεί για ειδοποιηθείτε όταν το κλειδί ΑΡΙ σας θα πλησιάζει στη λήξη του.';
$lang['The secret key can no longer be displayed.'] = 'Το κρυφό κλειδί δεν μπορεί να απεικονιστεί πλέον.';
$lang['To continue using the API, please renew your key before it expires.'] = 'Για να συνεχίσετε να χρησιμοποιείτε το ΑΡΙ, παρακαλώ ανανεώστε το κλειδί σας πριν λήξει.';
$lang['To manage your API keys, please log in with your username/password.'] = 'Για να επεξεργαστείτε τα κλειδιά ΑΡΙ σας, παρακαλώ συνδεθείτε με το όνομα χρήστη/κωδικό σας.';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Όταν είναι ενεργοποιημένο, χρησιμοποιείται ένα κοινό σχέδιο για τις σελίδες σύνδεσης και καταχώρησης, ανεξάρτητα από το θέμα που έχει ρυθμιστεί.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Μπορείτε να επεξεργαστείτε τα κλειδιά σας ΑΡΙ στις <a href="%s">Ρυθμίσεις Λογαριασμού</a> σας.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Δεν έχετε διεύθυνση E-Mail, δεν θα ειδοποιηθείτε όταν το κλειδί σας ΑΡΙ πλησιάζει στη λήξη του.';
$lang['Custom date'] = 'Επιλεγόμενη ημερομηνία';
$lang['Do you really want to revoke the "%s" API key?'] = 'Θέλετε πράγματι να ανακαλέσετε το κλειδί ΑΡΙ "%s";';
$lang['Don\'t have an account yet ?'] = 'Δεν έχετε ακόμη λογαριασμό;';
$lang['Done'] = 'Έγινε';
$lang['Duration'] = 'Διάρκεια';
$lang['Edit API Key'] = 'Επεξεργαστείτε το κλειδί ΑΡΙ';
$lang['Expert mode'] = 'Λειτουργία Ειδικού';
$lang['Expired'] = 'Έληξε';
$lang['Expired on'] = 'Έληξε την';
$lang['Expires in'] = 'Λήγει σε';
$lang['Generate API Key'] = 'Δημιούργησε το κλειδί ΑΡΙ';
$lang['Generate key'] = 'Δημιούργησε το κλειδί';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Γειά σου <em>%s</em>, δώσε τον κωδικό σου παρακάτω.';
$lang['Hide expired keys'] = 'Απέκρυψε τα ληγμένα κλειδιά';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Αδύνατη η αυτόματη αντιγραφή. Παρακαλώ αντιγράψτε χειροκίνητα.';
$lang['Last use'] = 'Τελευταία χρήση';
$lang['Manage your account'] = 'Επεξεργαστείτε τον λογαριασμό σας';
$lang['Never'] = 'Ποτέ';
$lang['New API Key'] = 'Νέο κλειδί ΑΡΙ';
$lang['No expiration'] = 'Χωρίς λήξη';
$lang['3xlarge'] = '3XL - Πολύ μεγάλες';
$lang['4xlarge'] = '4ΧΛ - Γιγαντιαίες';
$lang['API Key has been successfully edited.'] = 'Το κλειδί ΑΡΙ επεξεργάστηκε με επιτυχία.';
$lang['API Key has been successfully revoked.'] = 'Το κλειδί ΑΡΙ αποσύρθηκε με επιτυχία.';
$lang['API Key name'] = 'Όνομα κλειδιού ΑΡΙ';
$lang['API Key not found'] = 'Το κλειδί ΑΡΙ δεν βρέθηκε';
$lang['API Keys'] = 'Κλειδιά ΑΡΙ';
$lang['Account'] = 'Λογαριασμός';
$lang['Already have an account ?'] = 'Έχετε ήδη λογαριασμό;';
$lang['An email has been sent with a link to reset your password'] = 'Έχει αποσταλεί ένα E-Mail με ένα σύνδεσμο για να επαναφέρετε τον κωδικό σας';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Συνέβη κάποιο σφάλμα, παρακαλώ επιστρέψτε στο  <a href="identification.php" title="Σύνδεση">Σύνδεση</a> ή <a href="register.php">Καταχώρηση</a>';
$lang['Change your password'] = 'Αλλάξτε τον κωδικό σας';
$lang['Check your inbox'] = 'Ελέγξτε το φάκελο εισερχομένων';
$lang['Choose how you want to see your gallery'] = 'Επιλέξτε πώς θέλετε να δείτε την πινακοθήκη σας';
$lang['Confirm my new password'] = 'Επιβεβαιωση του νέου μου κωδικού';
$lang['Confirm new password'] = 'Επιβεβαίωσε τον νέο κωδικό';
$lang['Create API Keys to secure your acount'] = 'Δημιουργήστε κλειδιά ΑΡΙ για να ασφαλίσετε τον λογαριασμό σας';
$lang['Create a new API key to secure your account.'] = 'Δημιουργήστε ένα νέο κλειδί ΑΡΙ για να ασφαλίσετε τον λογαριασμό σας.';
$lang['Create an account'] = 'Δημιουργήστε ένα λογαριασμό';
$lang['Created at'] = 'Δημιουργήθηκε ';
$lang['ID copied.'] = 'Το ID αντιγράφτηκε.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Αν δεν λάβετε το e-mail, παρακαλώ επικοινωνήστε με τον διαχειριστή της σελίδας.';
$lang['Invalid verification code'] = 'Άκυρος κωδικός επαλήθευσης';
$lang['Save your ID and secret'] = 'Σώστε το ID και την μυστική σας λέξη';
...
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Εάν ο λογαριασμός σας υπάρχει, έχει σταλεί ένας κωδικός επαλήθευσης στη διεύθυνση email σας.';
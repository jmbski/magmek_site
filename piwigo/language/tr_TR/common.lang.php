...
$lang['To continue using the API, please renew your key before it expires.'] = 'API\'yi kullanmaya devam etmek için lütfen anahtarınızın süresi dolmadan önce yenileyin.';
$lang['To manage your API keys, please log in with your username/password.'] = 'API anahtarlarınızı yönetmek için lütfen kullanıcı adınız/şifrenizle giriş yapın.';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Etkinleştirildiğinde, tema ne olursa olsun giriş ve kayıt sayfaları için ortak bir şablon kullanılır.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'API anahtarlarınızı <a href="%s">hesap ayarlarınızdan</a> yönetebilirsiniz.';
...
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = '<a href="identification.php" title="Oturum aç">Oturum aç</a> sayfasına geri dön';
$lang['Options'] = 'Seçenekler';
$lang['No expiration'] = 'Son kullanma tarihi yok';
$lang['New API Key'] = 'Yeni API Anahtarı';
$lang['Manage your account'] = 'Hesabınızı yönetin';
$lang['Never'] = 'Asla';
$lang['Last use'] = 'Son kullanım';
$lang['Hide expired keys'] = 'Süresi dolmuş anahtarları gizle';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Otomatik olarak kopyalamak mümkün değil. Lütfen manuel olarak kopyalayın.';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Merhaba <em>%s</em>, aşağıya yeni şifrenizi girin.';
$lang['Generate API Key'] = 'API Anahtarı Oluştur';
$lang['Generate key'] = 'Anahtar oluştur';
$lang['Expires in'] = 'Şu zaman sonra sona erecek';
$lang['Expired on'] = 'Sona erecek';
$lang['Expired'] = 'Sona erdi';
$lang['Expert mode'] = 'Uzman modu';
$lang['Edit API Key'] = 'API Anahtarını Düzenle';
$lang['Duration'] = 'Süre';
$lang['Done'] = 'Tamamlandı';
$lang['Don\'t have an account yet ?'] = 'Halen bir hesabınız yok mu?';
$lang['Do you really want to revoke the "%s" API key?'] = '"%s" API anahtarını gerçekten iptal etmek istiyor musunuz?';
$lang['Custom date'] = 'Özel tarih';
$lang['Created at'] = 'Oluşturuldu:';
$lang['Create a new API key to secure your account.'] = 'Hesabınızı güvence altına almak için yeni bir API anahtarı oluşturun.';
$lang['Create API Keys to secure your acount'] = 'Hesabınızı güvence altına almak için API Anahtarları oluşturun';
$lang['Create an account'] = 'Bir hesap açın';
$lang['Change your password'] = 'Şifrenizi değiştirin';
$lang['Check your inbox'] = 'Gelen kutunuzu kontrol edin';
$lang['Choose how you want to see your gallery'] = 'Galerinizi nasıl görmek istediğinizi seçin';
$lang['Confirm my new password'] = 'Yeni şifremi onayla';
$lang['Confirm new password'] = 'Yeni şifreyi onayla';
$lang['An email has been sent with a link to reset your password'] = 'Şifrenizi sıfırlamak için bir bağlantı içeren bir e-posta gönderildi';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Bir hata oluştu. Lütfen <a href="identification.php" title="Oturum aç">Oturum aç</a> veya <a href="register.php">Kayıt ol</a> adresine geri dönün.';
$lang['Already have an account ?'] = 'Zaten bir hesabınız var mı?';
$lang['Account'] = 'Hesap';
$lang['3xlarge'] = '3XL - ekstra büyük';
$lang['4xlarge'] = '4XL - devasa';
$lang['API Key has been successfully edited.'] = 'API Anahtarı başarıyla düzenlendi.';
$lang['API Key has been successfully revoked.'] = 'API Anahtarı başarıyla iptal edildi.';
$lang['API Key name'] = 'API Anahtar adı';
$lang['API Key not found'] = 'API Anahtarı bulunamadı';
$lang['API Keys'] = 'API Anahtarları';
$lang['Your API key will expire in %d day.'] = 'API anahtarınız %d gün içinde sona erecek.';
$lang['Your API key will expire in %d days.'] = 'API anahtarınız %d gün içinde sona erecek.';
$lang['Your API key will expire soon'] = 'API anahtarınız yakında sona erecek';
$lang['Your changes have been applied.'] = 'Değişiklikleriniz uygulandı.';
...
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Şifrenizi çalındığını düşündüğünüz için değiştirdiyseniz, profilinizdeki %d API anahtarınızı iptal etmenizi öneririz <a href="%s"></a>';

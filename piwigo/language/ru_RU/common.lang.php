...
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Если Вы изменили свой пароль, потому что думаете, что он был украден, мы рекомендуем отозвать Ваши %d ключи API <a href="%s">в Вашем профиле</a>.';
$lang['you must choose a date'] = 'Вы должны выбрать дату';
$lang['No expiration'] = 'Нет срока годности';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Вернуться на <a href="identification.php" title="Войти">страницу Входа</a>';
$lang['Options'] = 'Параметры';
$lang['Revoked'] = 'Отозван';
$lang['Revoke'] = 'Отозвать';
$lang['Return to the gallery'] = 'Вернуться в галерею';
$lang['New API Key'] = 'Новый Ключ API';
$lang['Never'] = 'Никогда';
$lang['Manage your account'] = 'Управляйте своей учетной записью';
$lang['Last use'] = 'Последнее использование';
$lang['Invalid verification code'] = 'Неправильный проверочный код';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Невозможно скопировать автоматически. Пожалуйста, скопируйте вручную.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Если Вы не получиди письмо, пожалуйста, свяжитесь со своим вебмастером.';
$lang['If this wasn\'t you, please change your password immediately or contact your webmaster.'] = 'Если это были не Вы, пожалуйста, измените свой пароль немедленно или свяжитесь с Вашим вебмастером.';
$lang['ID copied.'] = 'ID скопирован';
$lang['Hide expired keys'] = 'Скрыть ключи с истёкшим сроком действия';
$lang['Here is your verification code:'] = 'Это Ваш проверочный код:';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Привет <em>%s</em>, введите Ваш пароль ниже.';
$lang['must not be empty'] = 'не должно быть пустым';
$lang['edit user preferences'] = 'редактировать пользовательские настройки';
$lang['Your verification code'] = 'Ваш проверочный код';
$lang['Your password was successfully set'] = 'Ваш пароль был успешно установлен';
$lang['Your password was successfully reset'] = 'Ваш пароль был успешно обновлен';
$lang['Your changes have been applied.'] = 'Ваши изменения были сохранены.';
$lang['Your API key will expire soon'] = 'Срок действия Вашего ключа API скоро истечёт';
$lang['Your API key will expire in %d days.'] = 'Срок действия Вашего ключа API истечёт через %d дней.';
$lang['Your API key will expire in %d day.'] = 'Срок действия Вашего ключа API истечёт через %d день.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'У Вас не указан почтовый адрес, поэтому Вы не будете уведомлены о том, что срок действия Вашего ключа API скоро истечет.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Вы можете управлять Вашими ключами API в <a href="%s">настройках Вашей учетной записи.</a>';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Когда разрешено, общий шаблон будет использован для страниц входа и регистрации, вне зависимости от используемой темы.';
$lang['Verify'] = 'Проверьте';
$lang['Verification successful! You can now choose a new password.'] = 'Проверка выполнена успешно! Теперь Вы можете выбрать новый пароль.';
$lang['Verification code'] = 'Проверочный код';
$lang['Secret copied. Keep it in a safe place.'] = 'Секретный ключ скопирован. Сохраните его в надежном месте.';
$lang['Save your ID and secret'] = 'Сохраните Ваш ID и секретный ключ';
$lang['Too many attempts, please try later..'] = 'Слишком много попыток, пожалуйста, попробуйте позже...';
$lang['To manage your API keys, please log in with your username/password.'] = 'Чтобы управлять Вашими ключами API, пожалуйста, войдите с Вашими именем пользователя/паролем.';
$lang['To continue using the API, please renew your key before it expires.'] = 'Чтобы продолжить использовать API, пожалуйста, обновите Ваш ключ до того, как его действие истечёт.';
$lang['This API key was manually revoked on %s'] = 'Этот ключ API был вручную отозван %s';
$lang['The secret will no longer be displayed. You must copy it to continue.'] = 'Секретный ключ не будет далее отображаться. Вы должны скопировать его, чтобы продолжить.';
$lang['The secret key can no longer be displayed.'] = 'Секретный ключ не может быть более показан.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Почтовый адрес %s будет использован, чтобы известить Вас, что Ваш ключ API скоро истечёт';
$lang['The api key has been successfully created.'] = 'Ключ API был создан успешно';
$lang['Show expired keys'] = 'Показать истекшие ключи';
$lang['Set your password below.'] = 'Задайте Ваш пароль ниже';
$lang['Set my password'] = 'Задать мой пароль';
$lang['Generate key'] = 'Сгенерировать ключ';
$lang['Generate API Key'] = 'Сгенерировать Ключ API';
$lang['Expires in'] = 'Истечёт через';
$lang['Expired on'] = 'Истёк';
$lang['Expired'] = 'Истёк';
$lang['Expert mode'] = 'Экспертный режим';
$lang['Edit API Key'] = 'Редактировать Ключ API';
$lang['Duration'] = 'Продолжительность';
$lang['Done'] = 'Сделано';
$lang['Don\'t have an account yet ?'] = 'У Вас еще нет учетной записи?';
$lang['Do you really want to revoke the "%s" API key?'] = 'Вы действительно хотите отозвать "%s" ключ API?';
$lang['Custom date'] = 'Пользовательская дата';
$lang['Created at'] = 'Создано в';
$lang['Create an account'] = 'Создать учетную запись';
$lang['Create a new API key to secure your account.'] = 'Создать новый ключ API, чтобы обезопасить Вашу учетную запись';
$lang['Create API Keys to secure your acount'] = 'Создать Ключи API, чтобы обезопасить Вашу учетную запись';
$lang['Confirm new password'] = 'Подтвердить новый пароль';
$lang['Confirm my new password'] = 'Подтвердить мой новый пароль';
$lang['Choose how you want to see your gallery'] = 'Выберите, как Вы хотите видеть Вашу галерею';
...
$lang['API Key has been successfully revoked.'] = 'Ключ API успешно отозван';
$lang['API Keys'] = 'Ключи API';
$lang['API Key not found'] = 'Ключ API не найден';

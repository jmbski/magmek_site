...
$lang['Expired on'] = 'Vanheni';
$lang['Expires in'] = 'Vanhenee';
$lang['Create an account'] = 'Luo käyttäjätili';
$lang['Created at'] = 'Luotu';
$lang['Do you really want to revoke the "%s" API key?'] = 'Haluatko varmasti perua API-avaimen "%s"?';
$lang['Create API Keys to secure your acount'] = 'Luo API-avain turvataksesi tilisi';
$lang['Create a new API key to secure your account.'] = 'Luo uusi API-avain turvataksesi tilisi.';
$lang['Change your password'] = 'Vaihda salasanasi';
$lang['Check your inbox'] = 'Tarkista saapuneet';
$lang['Choose how you want to see your gallery'] = 'Valitse miten haluat nähdä galleriasi';
$lang['Confirm my new password'] = 'Vahvista uusi salasanasi';
$lang['Confirm new password'] = 'Vahvista uusi salasana';
$lang['Already have an account ?'] = 'Onko sinulla jo käyttäjätili?';
$lang['An email has been sent with a link to reset your password'] = 'Salasanan nollauslinkki on lähetetty sähköpostitse';
$lang['An email has been sent with a verification code'] = 'Vahvistuskoodi on lähetetty sähköpostitse';
$lang['Account'] = 'Käyttäjätili';
$lang['API Key has been successfully edited.'] = 'API-avaimen muokkaus onnistui.';
$lang['API Key has been successfully revoked.'] = 'API-avaimen peruminen onnistui.';
$lang['API Key name'] = 'API-avaimen nimi';
$lang['API Key not found'] = 'API-avainta ei löytynyt';
$lang['API Keys'] = 'API-avaimet';
$lang['3xlarge'] = '3XL - erityisen jättimäinen';
$lang['4xlarge'] = '4XL - giganttinen';
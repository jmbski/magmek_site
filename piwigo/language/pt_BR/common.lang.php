...
$lang['Options'] = 'Opções';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Voltar para <a href="identification.php" title="Entrar">Entrar</a>';
...
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Você pode gerenciar suas chaves de API nas <a href="%s">configurações da sua conta.</a>';
...
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Olá <em>%s</em>, digite sua nova senha abaixo.';
...
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Ocorreu um erro. Volte para <a href="identification.php" title="Entrar">Entrar</a> ou <a href="register.php">Registrar</a>';
...
$lang['If you changed your password because you think it was stolen, we recommend revoking your %d API keys <a href="%s">in your profile</a>.'] = 'Se você alterou sua senha porque acha que ela foi roubada, recomendamos revogar suas chaves de API %d <a href="%s">em seu perfil</a>.';
...
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Se a sua conta já existe, um código de verificação foi enviado para o seu endereço de e-mail.';
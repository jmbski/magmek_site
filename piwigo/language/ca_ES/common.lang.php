...
$lang['Set your password below.'] = 'Definiu la vostra contrasenya aquí sota.';
$lang['The api key has been successfully created.'] = 'La clau de l\'API s\'ha creat amb èxit.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'S\'utilitzarà el correu electrònic %s per avisar-vos quan la vostra clau d\'API estigui a punt de caducar.';
$lang['The secret key can no longer be displayed.'] = 'La clau secreta no es pot tornar a mostrar.';
$lang['This API key was manually revoked on %s'] = 'Aquesta clau d\'API es va revocar manualment el %s';
$lang['To continue using the API, please renew your key before it expires.'] = 'Per continuar utilitzant l\'API, renoveu la clau abans que caduqui.';
$lang['To manage your API keys, please log in with your username/password.'] = 'Per gestionar les vostres claus d\'API, inicieu la sessió amb el vostre usuari i contrasenya.';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Quan estigui habilitada, s\'utilitzarà una plantilla comuna per a les pàgines d\'inici de sessió i registre, independentment del tema.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Podeu gestionar les vostres claus d\'API als <a href="%s">paràmetres del compte</a>.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'No teniu adreça de correu electrònic; per tant no us podrem avisar quan la vostra clau d\'API estigui a punt de caducar.';
$lang['Your API key will expire in %d day.'] = 'La vostra clau d\'API caducarà en %d dia.';
$lang['Your API key will expire in %d days.'] = 'La vostra clau d\'API caducarà en %d dies.';
$lang['Your API key will expire soon'] = 'La vostra clau d\'API caducarà aviat';
$lang['Your changes have been applied.'] = 'S\'han aplicat els canvis.';
$lang['Your password was successfully reset'] = 'S\'ha restablert amb èxit la vostra contrasenya';
$lang['Your password was successfully set'] = 'S\'ha establert amb èxit la vostra contrasenya';
$lang['must not be empty'] = 'no pot estar buida';
$lang['you must choose a date'] = 'heu de triar una data';
$lang['3xlarge'] = '3XL - extra gegant';
$lang['4xlarge'] = '4XL - gegantí';
$lang['API Key has been successfully edited.'] = 'La clau d\'API s\'ha editat correctament.';
$lang['API Key has been successfully revoked.'] = 'La clau d\'API s\'ha revocat correctament.';
$lang['API Key name'] = 'Nom de la clau d\'API';
$lang['API Key not found'] = 'No s\'ha trobat la clau d\'API';
$lang['API Keys'] = 'Claus d\'API';
$lang['Account'] = 'Compte';
$lang['Already have an account ?'] = 'Ja teniu un compte?';
$lang['An email has been sent with a link to reset your password'] = 'S\'ha enviat un correu electrònic amb un enllaç per restablir la contrasenya.';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'S\'ha produït un error. Si us plau, torneu a <a href="identification.php" title="Iniciar sessió">Iniciar sessió</a> o a <a href="register.php">Registrar-vos</a>.';
$lang['Change your password'] = 'Canvieu la contrasenya';
$lang['Check your inbox'] = 'Reviseu la safata d\'entrada';
$lang['Choose how you want to see your gallery'] = 'Trieu com voleu veure la galeria';
$lang['Confirm my new password'] = 'Confirma la meva nova contrasenya';
$lang['Confirm new password'] = 'Confirmeu la nova contrasenya';
$lang['Create API Keys to secure your acount'] = 'Creeu claus d\'API per protegir el vostre compte';
$lang['Create a new API key to secure your account.'] = 'Creeu una nova clau d\'API per protegir el vostre compte.';
$lang['Create an account'] = 'Crea un compte';
$lang['Created at'] = 'Creat a';
$lang['Custom date'] = 'Data personalitzada';
$lang['Do you really want to revoke the "%s" API key?'] = 'Segur que voleu revocar la clau d\'API "%s"?';
$lang['Don\'t have an account yet ?'] = 'Encara no teniu un compte?';
$lang['Done'] = 'Fet';
$lang['Duration'] = 'Durada';
$lang['Edit API Key'] = 'Edita la clau d\'API';
$lang['Expert mode'] = 'Mode expert';
$lang['Expired'] = 'Caducada';
$lang['Expired on'] = 'Caducada el';
$lang['Expires in'] = 'Caduca el';
$lang['Generate API Key'] = 'Genera la clau d\'API';
$lang['Generate key'] = 'Genera la clau';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Hola, <em>%s</em>, introduïu la vostra nova contrasenya a continuació.';
$lang['Hide expired keys'] = 'Amaga les claus caducades';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Impossible copiar automàticament. Si us plau, copieu manualment.';
$lang['Last use'] = 'Darrer ús';
$lang['Manage your account'] = 'Gestioneu el vostre compte';
$lang['Never'] = 'Mai';
$lang['New API Key'] = 'Nova clau d\'API';
$lang['No expiration'] = 'Sense caducitat';
$lang['Options'] = 'Opcions';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Torneu a <a href="identification.php" title="Iniciar sessió">Iniciar sessió</a>';
$lang['Return to the gallery'] = 'Torna a la galeria';
$lang['Revoke'] = 'Revoca';
$lang['Revoked'] = 'Revocada';
$lang['Set my password'] = 'Estableix la meva contrasenya';
$lang['Show expired keys'] = 'Mostra les claus caducades';
$lang['ID copied.'] = 'ID copiat.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Si no rebeu el correu electrònic, poseu-vos en contacte amb el webmaster.';
$lang['Invalid verification code'] = 'Codi de verificació no vàlid';
$lang['Save your ID and secret'] = 'Deseu el vostre ID i secret';
$lang['Secret copied. Keep it in a safe place.'] = 'Secret copiat. Manteniu-lo en lloc segur.';
...
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Si el vostre compte existeix, s\'ha enviat un codi de verificació al vostre correu electrònic.';
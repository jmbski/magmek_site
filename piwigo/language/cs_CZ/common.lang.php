...
$lang['Custom date'] = 'Vlastní datum';
$lang['Do you really want to revoke the "%s" API key?'] = 'Opravdu chcete zneplatnit "%s" API klíč?';
$lang['Don\'t have an account yet ?'] = 'Nemáte zatím účet?';
$lang['Done'] = 'Hotovo';
$lang['Duration'] = 'Průběh';
$lang['Edit API Key'] = 'Editace API klíče';
$lang['Expert mode'] = 'Expert mód';
$lang['Expired'] = 'Expirován';
$lang['Expired on'] = 'Platnost expirovala dne';
$lang['Expires in'] = 'Expiruje v';
$lang['Generate API Key'] = 'Generuj API Klíč';
$lang['Generate key'] = 'Generuj klíč';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Ahoj <em>%s</em>, zadej nové heslo níže.';
$lang['Hide expired keys'] = 'Skrýt neplatné klíče';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Nelze kopírovat automaticky. Prosím kopírujte manuálně.';
$lang['Last use'] = 'Naposledy použito';
$lang['Manage your account'] = 'Správa účtu';
$lang['Never'] = 'Nikdy';
$lang['New API Key'] = 'Nový API klíč';
$lang['No expiration'] = 'Bez expirace';
$lang['3xlarge'] = '3XL - extra velký';
$lang['4xlarge'] = '4XL - gigantický';
$lang['API Key has been successfully edited.'] = 'API Klíč byl úspěšně editován.';
$lang['API Key has been successfully revoked.'] = 'API Klíč byl úspěšně revokován.';
$lang['API Key name'] = 'API název klíče';
$lang['API Key not found'] = 'API Klíč nebyl nalezen';
$lang['API Keys'] = 'API Klíče';
$lang['Account'] = 'Účet';
$lang['Already have an account ?'] = 'Máte již vytvořený účet ?';
$lang['An email has been sent with a link to reset your password'] = 'Byla vám zaslána zpráva s odkazem pro obnovu hesla';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Nastala chyba prosím jděte zpět na <a href="identification.php" title="Přihlásit se">Přihlásit se</a> nebo <a href="register.php">Registrace</a>';
$lang['Change your password'] = 'Změna hesla';
$lang['Check your inbox'] = 'Kontrola doručených';
$lang['Choose how you want to see your gallery'] = 'Vyberte si, jak chcete vidět vaši galerii';
$lang['Confirm my new password'] = 'Potvrzení nového hesla';
$lang['Confirm new password'] = 'Potvrzení nového hesla';
$lang['Create API Keys to secure your acount'] = 'Vytvořte API klíče pro ochranu vašeho účtu';
$lang['Create a new API key to secure your account.'] = 'Vytvořte nový API klíč pro ochranu vašeho účtu';
$lang['Create an account'] = 'Vytvořit účet';
$lang['Created at'] = 'Vytvořeno v';
$lang['Your API key will expire in %d day.'] = 'Váš API klíč expiruje za %d dny.';
$lang['Your API key will expire in %d days.'] = 'Váš API klíč expiruje za %d dnů.';
$lang['Your API key will expire soon'] = 'Váš API klíč expiruje brzy.';
$lang['Your changes have been applied.'] = 'Vaše změny byly nastaveny.';
$lang['Your password was successfully reset'] = 'Vaše heslo bylo úspěšně resetováno';
$lang['Your password was successfully set'] = 'Vaše heslo bylo úspěšně nastaveno';
$lang['must not be empty'] = 'musí být zadáno';
$lang['you must choose a date'] = 'vyberte datum';
$lang['Options'] = 'Možnosti';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Zpět na <a href="identification.php" title="Přihlásit se">Přihlásit se</a>';

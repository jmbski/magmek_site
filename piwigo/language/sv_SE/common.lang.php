...
$lang['Your API key will expire soon'] = 'Din API-nyckel kommer att löpa ut snart';
$lang['Your changes have been applied.'] = 'Dina ändringar har verkställts.';
$lang['Your password was successfully reset'] = 'Ditt lösenord har återställts';
$lang['Your password was successfully set'] = 'Ditt lösenord har satts';
$lang['must not be empty'] = 'kan inte vara tom';
$lang['you must choose a date'] = 'du måste välja ett datum';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Återgå till <a href="identification.php" title="Logga in">Logga in</a>';
$lang['Return to the gallery'] = 'Återgå till galleriet';
$lang['Revoke'] = 'Återkalla';
$lang['Revoked'] = 'Återkallad';
$lang['Set my password'] = 'Ställ in mitt lösenord';
$lang['Show expired keys'] = 'Visa nycklar som löpt ut';
$lang['The api key has been successfully created.'] = 'API-nyckeln har skapats.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'E-postadressen %s kommer att användas för att meddela dig när din API-nyckel snart löper ut.';
$lang['The secret key can no longer be displayed.'] = 'Den hemliga nyckeln kan ej längre visas.';
$lang['This API key was manually revoked on %s'] = 'Denna API-nyckel återkallades manuellt den %s';
$lang['To continue using the API, please renew your key before it expires.'] = 'För att kunna fortsätta använda API\'et, var god förnya din nyckel innan den löper ut.';
$lang['To manage your API keys, please log in with your username/password.'] = 'För att hantera dina API-nycklar, var god logga in med ditt användarnamn/lösenord.';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'När det är aktiverat används en gemensam mall för inloggnings- och registreringssidorna, oavsett tema.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Du kan hantera dina API-nycklar i dina <a href="%s">kontoinställningar.</a>';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Du har ingen epostadress, så du kommer inte att bli meddelad när din API-nyckel är på väg att löpa ut.';
$lang['Your API key will expire in %d day.'] = 'Din API-nyckel kommer att löpa ut om %d dag.';
$lang['Your API key will expire in %d days.'] = 'Din API-nyckel kommer att löpa ut om %d dagar.';
$lang['Don\'t have an account yet ?'] = 'Har du inget konto ännu ?';
$lang['Done'] = 'Klar';
$lang['Duration'] = 'Varaktighet';
$lang['Edit API Key'] = 'Redigera API-nyckel';
$lang['Expert mode'] = 'Expertläge';
$lang['Expired'] = 'Löpt ut';
$lang['Expired on'] = 'Löpte ut den';
$lang['Expires in'] = 'Löper ut om';
$lang['Generate API Key'] = 'Generera API-nyckel';
$lang['Generate key'] = 'Generera nyckel';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Hej <em>%s</em>, skriv in ditt lösenord nedan.';
$lang['Hide expired keys'] = 'Göm nycklar som löpt ut';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Omöjligt att kopiera automatiskt. Var god kopiera manuellt.';
$lang['Last use'] = 'Senast använd';
$lang['Manage your account'] = 'Hantera ditt konto';
$lang['Never'] = 'Aldrig';
$lang['New API Key'] = 'Ny API-nyckel';
$lang['No expiration'] = 'Inget utlöpsdatum';
$lang['Options'] = 'Alternativ';
$lang['API Key has been successfully edited.'] = 'API-nyckeln har redigerats.';
$lang['API Key has been successfully revoked.'] = 'API-nyckeln har återkallats.';
$lang['API Key name'] = 'API-nyckelnamn';
$lang['API Key not found'] = 'API-nyckel hittades inte';
$lang['API Keys'] = 'API-nycklar';
$lang['Account'] = 'Konto';
$lang['Already have an account ?'] = 'Har du redan ett konto ?';
$lang['An email has been sent with a link to reset your password'] = 'Ett mail har skickats med en länk för att återställa lösenordet';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Ett fel har uppstått. Gå tillbaka till <a href="identification.php" title="Logga in">Logga in</a> eller <a href="register.php">Registrera</a>.';
$lang['Change your password'] = 'Ändra ditt lösenord';
$lang['Check your inbox'] = 'Kolla din inkorg';
$lang['Choose how you want to see your gallery'] = 'Välj hur du vill se ditt galleri';
$lang['Confirm my new password'] = 'Bekräfta mitt nya lösenord';
$lang['Confirm new password'] = 'Bekräfta nytt lösenord';
$lang['Create API Keys to secure your acount'] = 'Skapa API-nycklar för att säkra ditt konto';
$lang['Create a new API key to secure your account.'] = 'Skapa en ny API-nyckel för att säkra ditt konto.';
$lang['Create an account'] = 'Skapa ett konto';
$lang['Created at'] = 'Skapad den';
$lang['Custom date'] = 'Eget datum';
$lang['Do you really want to revoke the "%s" API key?'] = 'Vill du verkligen återkalla API-nyckeln "%s"?';
$lang['3xlarge'] = '3XL - extra jättestor';
$lang['4xlarge'] = '4XL - gigantisk';
$lang['ID copied.'] = 'ID kopierat.';
$lang['If you do not receive the email, please contact your webmaster.'] = 'Om du inte får mejlet, var god kontakta din webbmaster.';
$lang['Invalid verification code'] = 'Ogiltig verifieringskod';
$lang['Save your ID and secret'] = 'Spara ditt ID och hemlighet';
$lang['Secret copied. Keep it in a safe place.'] = 'Hemlighet kopierad. Spara den på ett säkert ställe.';
...
$lang['If your account exists, a verification code has been sent to your email address.'] = 'Om ditt konto finns, skickas en verifieringskod till din e-post adress.';
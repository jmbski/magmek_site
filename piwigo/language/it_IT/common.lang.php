...
$lang['SQL queries in'] = 'Query SQL in';
...
$lang['Set your password below.'] = 'Imposta la tua password qui sotto.';
$lang['must not be empty'] = 'non può essere vuota';
$lang['Your changes have been applied.'] = 'Le tue modifiche sono state applicate.';
$lang['Your password was successfully reset'] = 'La tua password è stata reimpostata con successo.';
$lang['Your password was successfully set'] = 'La tua password è stata impostata.';
$lang['you must choose a date'] = 'devi scegliere una data';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Quando questa opzione è abilitata, per le pagine di accesso e registrazione viene utilizzato un tema comune, indipendentemente dal tema.';
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Puoi gestire le tue chiavi API nelle <a href="%s">impostazioni del tuo account</a>.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Non hai impostato un indirizzo email, quindi non riceverai alcuna notifica quando la tua chiave API sta per scadere.';
...
$lang['This API key was manually revoked on %s'] = 'La chiave API è stata revocata manualmente il %s';
...
$lang['Do you really want to revoke the "%s" API key?'] = 'Vuoi veramente revocare la chiave API "%s"?';
$lang['Don\'t have an account yet ?'] = 'Non hai ancora un account?';
$lang['Done'] = 'Fatto';
$lang['Duration'] = 'Durata';
$lang['Edit API Key'] = 'Modifica chiave API';
$lang['Expert mode'] = 'Modalità esperto';
$lang['Expired'] = 'Scaduta';
$lang['Expired on'] = 'Scaduta il';
$lang['Expires in'] = 'Scade in';
$lang['Generate API Key'] = 'Genera chiave API';
$lang['Generate key'] = 'Genera chiave';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Salve, <em>%s</em>, inserisci la tua nuova password qui sotto';
$lang['Hide expired keys'] = 'Nascondi le chiavi scadute';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Impossibile copiare automaticamente. Prego copiare manualmente';
$lang['Last use'] = 'Ultimo utilizzo';
$lang['Manage your account'] = 'Gestisci il tuo account';
$lang['Never'] = 'Mai';
$lang['New API Key'] = 'Nuova chiave API';
$lang['No expiration'] = 'Nessuna scadenza';
$lang['3xlarge'] = '3XL - extra grande';
$lang['4xlarge'] = '4XL - gigante';
$lang['API Key has been successfully edited.'] = 'La chiave API è stata correttamente modificata.';
$lang['API Key has been successfully revoked.'] = 'La chiave API è stata correttamente revocata.';
$lang['API Key name'] = 'Nome chiave API';
$lang['API Key not found'] = 'Chiave API non trovata';
$lang['API Keys'] = 'Chiavi API';
$lang['Account'] = 'Account';
$lang['Already have an account ?'] = 'Hai già un account?';
$lang['An email has been sent with a link to reset your password'] = 'È stata inviata un\'e-mail con un collegamento per reimpostare la password';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Si è verificato un errore. Torna su <a href="identification.php" title="Accedi">Accedi</a> o <a href="register.php">Registrati</a>';
$lang['Change your password'] = 'Cambia la tua password';
$lang['Check your inbox'] = 'Controlla la tua posta in arrivo';
$lang['Choose how you want to see your gallery'] = 'Scegli come visualizzare la tua galleria';
$lang['Confirm my new password'] = 'Conferma la mia nuova password';
$lang['Confirm new password'] = 'Conferma nuova password';
$lang['Create API Keys to secure your acount'] = 'Crea una chiave API per mettere in sicurezza il tuo account';
